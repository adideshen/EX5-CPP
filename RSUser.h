...
public:
	 ...
	 */
	 RSUser (const std::string& username, const rank_map& rank_map,
	 ...
	 * @return the username
	 */
    const std::string& get_name() const {return _username;}
     ...
     * @return
     */
     const rank_map& get_ranks() const {return _rank_map;}
 ...
 private:
  ...
  rank_map _rank_map;
  std::shared_ptr<RecommenderSystem> _sp_recommender_system;
};
